...
function preload() {
  ...
  // 🔥 FIX IMPORTANT INTRO IMAGES
  let pageIndex = floor(random(1, 43));
  let path = "Pages/page" + pageIndex + ".png";

  introPage = loadImage(path, 
    () => console.log("intro loaded:", path),
    () => console.error("intro FAILED:", path)
  );
}
